...
_BATCHVULNERABILITYLIST = DESCRIPTOR.message_types_by_name[
    'BatchVulnerabilityList']
_QUERY = DESCRIPTOR.message_types_by_name['Query']
_BATCHQUERY = DESCRIPTOR.message_types_by_name['BatchQuery']
_GETVULNBYIDPARAMETERS = DESCRIPTOR.message_types_by_name[
    'GetVulnByIdParameters']
_QUERYAFFECTEDPARAMETERS = DESCRIPTOR.message_types_by_name[
    'QueryAffectedParameters']
_QUERYAFFECTEDBATCHPARAMETERS = DESCRIPTOR.message_types_by_name[
    'QueryAffectedBatchParameters']
_DETERMINEVERSIONPARAMETERS = DESCRIPTOR.message_types_by_name[
...
_VERSIONMATCH_CPESENTRY = _VERSIONMATCH.nested_types_by_name['CpesEntry']
_VERSIONREPOSITORYINFORMATION = DESCRIPTOR.message_types_by_name[
    'VersionRepositoryInformation']
_VERSIONREPOSITORYINFORMATION_REPOTYPE = _VERSIONREPOSITORYINFORMATION.enum_types_by_name[
    'RepoType']
VulnerabilityList = _reflection.GeneratedProtocolMessageType(
    'VulnerabilityList',
    (_message.Message,),
    {
...
BatchVulnerabilityList = _reflection.GeneratedProtocolMessageType(
    'BatchVulnerabilityList',
    (_message.Message,),
    {
...
BatchQuery = _reflection.GeneratedProtocolMessageType(
    'BatchQuery',
    (_message.Message,),
    {
...
GetVulnByIdParameters = _reflection.GeneratedProtocolMessageType(
    'GetVulnByIdParameters',
    (_message.Message,),
    {
...
QueryAffectedParameters = _reflection.GeneratedProtocolMessageType(
    'QueryAffectedParameters',
    (_message.Message,),
    {
...
QueryAffectedBatchParameters = _reflection.GeneratedProtocolMessageType(
    'QueryAffectedBatchParameters',
    (_message.Message,),
    {
...
DetermineVersionParameters = _reflection.GeneratedProtocolMessageType(
    'DetermineVersionParameters',
    (_message.Message,),
    {
...
VersionQuery = _reflection.GeneratedProtocolMessageType(
    'VersionQuery',
    (_message.Message,),
    {
...
FileHash = _reflection.GeneratedProtocolMessageType(
    'FileHash',
    (_message.Message,),
    {
...
VersionMatchList = _reflection.GeneratedProtocolMessageType(
    'VersionMatchList',
    (_message.Message,),
    {
...
VersionMatch = _reflection.GeneratedProtocolMessageType(
    'VersionMatch',
    (_message.Message,),
    {
        'CpesEntry':
            _reflection.GeneratedProtocolMessageType(
                ...
                (_message.Message,),
                {
                    'DESCRIPTOR': _VERSIONMATCH_CPESENTRY,
                    '__module__': 'osv_service_v1_pb2'
                    # @@protoc_insertion_point(class_scope:osv.v1.VersionMatch.CpesEntry)
                }),
        'DESCRIPTOR':
            _VERSIONMATCH,
        '__module__':
...
_sym_db.RegisterMessage(VersionMatch.CpesEntry)

VersionRepositoryInformation = _reflection.GeneratedProtocolMessageType(
    'VersionRepositoryInformation',
    (_message.Message,),
    {
        'DESCRIPTOR': _VERSIONREPOSITORYINFORMATION,
        '__module__': 'osv_service_v1_pb2'
        # @@protoc_insertion_point(class_scope:osv.v1.VersionRepositoryInformation)
    })
_sym_db.RegisterMessage(VersionRepositoryInformation)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _OSV.methods_by_name[
      'GetVulnById']._serialized_options = b'\202\323\344\223\002\020\022\016/v1/vulns/{id}'
  _OSV.methods_by_name['QueryAffected']._options = None
  _OSV.methods_by_name[
      'QueryAffected']._serialized_options = b'\202\323\344\223\002\022\"\t/v1/query:\005query'
  _OSV.methods_by_name['QueryAffectedBatch']._options = None
  _OSV.methods_by_name[
      'QueryAffectedBatch']._serialized_options = b'\202\323\344\223\002\027\"\016/v1/querybatch:\005query'
  _OSV.methods_by_name['DetermineVersion']._options = None
  _OSV.methods_by_name[
      'DetermineVersion']._serialized_options = b'\202\323\344\223\002)\" /v1experimental/determineversion:\005query'
