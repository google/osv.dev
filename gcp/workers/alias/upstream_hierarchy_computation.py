...
def main():
  """ Updates all upstream groups in the datastore with 
   their upstream hierarchy relationships """
  # Find all of the upstream groups
  all_upstream_group = osv.UpstreamGroup.query()

  for group in all_upstream_group:
