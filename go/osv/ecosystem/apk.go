...
var _ Ecosystem = apkEcosystem{}

func (e apkEcosystem) Parse(version string) (Version, error) {
	ver, err := semantic.ParseAlpineVersion(version)
	if err != nil {
		return nil, err
	}
...
func (e apkEcosystem) IsSemver() bool {
	return false
}
