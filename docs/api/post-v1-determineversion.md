...
3. You can use [gcloud storage](https://cloud.google.com/sdk/gcloud/reference/storage) to copy everything: `gcloud storage cp --recursive gs://osv-indexer-configs/ .`
