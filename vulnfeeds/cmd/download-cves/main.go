...
func downloadCVE2FromAPIWithOffset(apiKey string, offset int) (page *cves.CVEAPIJSON20Schema, err error) {
	client := &http.Client{}
...
// See https://nvd.nist.gov/developers/vulnerabilities
func downloadCVE2FromAPI(apiKey string, cvePath string) {
