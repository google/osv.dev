...
func TestDefaultVersionExtractor_SliceOrderPrecedence(t *testing.T) {
	...
	extractor1 := &DefaultVersionExtractor{
		Strategies: []strategies.VersionStrategy{
			&strategies.StandardRangeStrategy{},
			&strategies.StandaloneSingleVersionStrategy{},
		},
	}
	ranges1, _ := extractor1.FindNormalAffectedRanges(affected, &models.ConversionMetrics{})
	...
	extractor2 := &DefaultVersionExtractor{
		Strategies: []strategies.VersionStrategy{
			&strategies.StandaloneSingleVersionStrategy{},
			&strategies.StandardRangeStrategy{},
		},
	}
	ranges2, _ := extractor2.FindNormalAffectedRanges(affected, &models.ConversionMetrics{})
