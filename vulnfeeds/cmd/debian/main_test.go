	...
	want := map[string]*vulns.Vulnerability{
		"CVE-2018-1000500": {
			Vulnerability: osvschema.Vulnerability{
				...
				Affected: []osvschema.Affected{
					{Package: osvschema.Package{Name: "busybox", Ecosystem: "Debian:10"}, EcosystemSpecific: map[string]interface{}{"urgency": "end-of-life"}},
					{Package: osvschema.Package{Name: "busybox", Ecosystem: "Debian:11"}, EcosystemSpecific: map[string]interface{}{"urgency": "unimportant"}},
					{Package: osvschema.Package{Name: "busybox", Ecosystem: "Debian:12"}, EcosystemSpecific: map[string]interface{}{"urgency": "unimportant"}},
					{Package: osvschema.Package{Name: "busybox", Ecosystem: "Debian:13"}, EcosystemSpecific: map[string]interface{}{"urgency": "unimportant"}},
				},
		...
		"CVE-2016-1585": {
			Vulnerability: osvschema.Vulnerability{
				...
				Affected: []osvschema.Affected{
					{Package: osvschema.Package{Name: "apparmor", Ecosystem: "Debian:10"}, EcosystemSpecific: map[string]interface{}{"urgency": "unimportant"}},
					{Package: osvschema.Package{Name: "apparmor", Ecosystem: "Debian:11"}, EcosystemSpecific: map[string]interface{}{"urgency": "unimportant"}},
					{Package: osvschema.Package{Name: "apparmor", Ecosystem: "Debian:12"}, EcosystemSpecific: map[string]interface{}{"urgency": "unimportant"}},
					{
						...
						EcosystemSpecific: map[string]interface{}{"urgency": "unimportant"},
					},
				},
				...
				Affected: []osvschema.Affected{
					{
						...
						EcosystemSpecific: map[string]interface{}{"urgency": "not yet assigned"},
					},
					{
