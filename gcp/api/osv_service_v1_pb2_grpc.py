...
class OSVStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetVulnById = channel.unary_unary(
                ...
                response_deserializer=osv_dot_osv__schema_dot_proto_dot_vulnerability__pb2.Vulnerability.FromString,
...
def add_OSVServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetVulnById': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=osv_dot_osv__schema_dot_proto_dot_vulnerability__pb2.Vulnerability.SerializeToString,
            ),
...
class OSV(object):
    ...
    def GetVulnById(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            osv_dot_osv__schema_dot_proto_dot_vulnerability__pb2.Vulnerability.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
